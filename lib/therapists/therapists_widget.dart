                  ...
                  children: [
                    StreamBuilder<List<TherapistsRecord>>(
                        ...
                        queryBuilder: (therapistsRecord) =>
                            therapistsRecord.where('therapist_Loc',
                                arrayContains: therapistsTherapistsRecord
                                            ...
                                            .toString() !=
                                        ''
                                    ? therapistsTherapistsRecord.therapistLoc
                                        .toList()
                                        .length
                                        .toString()
                                    : null),
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<TherapistsRecord> dropDownTherapistsRecordList =
                            snapshot.data;
                                              ...
                                              final likedByUpdate =
                                                  therapistsTherapistsRecord
                                                      ...
                                                      : FieldValue.arrayUnion(
                                                          [likedByElement]);
                                              final therapistsUpdateData = {
                                                'liked_by': likedByUpdate,
                                              };
                                              await therapistsTherapistsRecord
                                                  .reference
                                                  .update(therapistsUpdateData);
                                            },
                                            value: therapistsTherapistsRecord
                                                .likedBy
                                                .toList()
