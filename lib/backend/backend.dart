...
import 'schema/therapists_record.dart';
...
export 'schema/therapists_record.dart';
export 'schema/users_record.dart';
export 'schema/rating_record.dart';

/// Functions to query TherapistsRecords (as a Stream and as a Future).
Stream<List<TherapistsRecord>> queryTherapistsRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TherapistsRecord.collection,
...
Future<List<TherapistsRecord>> queryTherapistsRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<TherapistsRecord>> queryTherapistsRecordPage({
  Query Function(Query) queryBuilder,
