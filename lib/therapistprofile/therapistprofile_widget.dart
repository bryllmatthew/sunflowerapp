...
class _TherapistprofileWidgetState extends State<TherapistprofileWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<TherapistsRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<TherapistsRecord> columnTherapistsRecordList = snapshot.data;
          // Return an empty Container when the document does not exist.
          if (snapshot.data.isEmpty) {
            return Container();
          }
          final columnTherapistsRecord = columnTherapistsRecordList.isNotEmpty
              ? columnTherapistsRecordList.first
              : null;
              ...
              children: [
                ...
                StreamBuilder<List<RatingRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<RatingRecord> ratingBarRatingRecordList =
                        snapshot.data;
                    return RatingBarIndicator(
                      ...
                      rating: ratingBarRatingRecordList.length.toDouble(),
